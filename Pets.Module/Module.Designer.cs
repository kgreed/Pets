namespace Pets.Module {
	partial class PetsModule {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			// PetsModule
			// 
			this.AdditionalExportedTypes.Add(typeof(Pets.Module.BusinessObjects.ApplicationUser));
			...
			this.RequiredModuleTypes.Add(typeof(DevExpress.ExpressApp.AuditTrail.EFCore.AuditTrailModule));
